...
<body>
    ...
    <h1>Upute za aplikaciju</h1>
    <hr>
    <p>Pošto prvi put ulazite na stranicu potrebna su vam uputstva: </p>
    <ul>
    ...
    <p>Ako se slažete sa svim uslovima, kliknite OK da pređete na stranicu za login</p>

    <button onclick="location.href='/moci/Register/login'">OK</button>
